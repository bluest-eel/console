...
<div>
  <b-row>
    <b-colxx xxs="12">
      <beap-breadcrumb :heading="$t('menu.mailing')"/>
                        ...
                        <td colSpan="2" style="padding-top:10px; border-top:1px solid #e4e2e2">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:0px; padding-bottom:20px;">
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:20px;"><a href="#"
                                                style="text-decoration: none; color:#303030; font-weight:500;">Marble Cake</a></h4>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:0px; padding-bottom:20px;">
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:20px;"><a href="#"
                                                style="text-decoration: none; color:#303030; font-weight:500;">Chocolate Cake</a></h4>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:0px; padding-bottom:20px;">
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:20px;"><a href="#"
                                                style="text-decoration: none; color:#303030; font-weight:500;">Fat Rascal</a></h4>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="padding-bottom: 30px;">
                                        ...
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:5px; margin-top: 10px;"><a
                                                href="#" style="text-decoration: none; color:#303030; font-weight:500;">Distinctively Exploit Optimal Alignments</a></h4>
                                        ...
                                        <p style="font-size: 14px; line-height: 1; margin-top:5px;"><a style="color:#f18024; text-decoration:initial;"
                                                href="#">Learn More</a></p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding-bottom: 30px;">
                                        ...
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:5px; margin-top: 10px;"><a
                                                href="#" style="text-decoration: none; color:#303030; font-weight:500;">Assertively Iterate Resource Maximizing</a></h4>
                                        <p style="color:#8f8f8f; font-size: 14px; line-height: 1.4; margin-top:10px">
                                            Objectively integrate emerging core competencies before integrate emerging process-centric communities.
                                        </p>
                                        <p style="font-size: 14px; line-height: 1; margin-top:5px;"><a style="color:#f18024; text-decoration:initial;"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <h4 style="font-size: 16px; line-height: 1; margin-bottom:5px; margin-top: 10px;"><a
                                                href="#" style="text-decoration: none; color:#303030; font-weight:500;">Objectively Manufactured Products</a></h4>
                                        <p style="color:#8f8f8f; font-size: 14px; line-height: 1.4; margin-top:10px">
                                            Objectively integrate emerging core competencies before integrate emerging process-centric communities.
                                        </p>
                                        <p style="font-size: 14px; line-height: 1; margin-top:5px;"><a style="color:#f18024; text-decoration:initial;"
